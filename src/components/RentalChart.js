        ...
        case order.date.split('-')[1] === '01':
          ...
          items.forEach((item) => {
            janOrderItems.forEach((janOrderItem) => {
              if ((janOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '02':
          ...
          items.forEach((item) => {
            febOrderItems.forEach((febOrderItem) => {
              if ((febOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '03':
          ...
          items.forEach((item) => {
            marchOrderItems.forEach((marchOrderItem) => {
              if ((marchOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '04':
          ...
          items.forEach((item) => {
            apOrderItems.forEach((apOrderItem) => {
              if ((apOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '05':
          ...
          items.forEach((item) => {
            mayOrderItems.forEach((mayOrderItem) => {
              if ((mayOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '06':
          ...
          items.forEach((item) => {
            juneOrderItems.forEach((juneOrderItem) => {
              if ((juneOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '07':
          ...
          items.forEach((item) => {
            julyOrderItems.forEach((julyOrderItem) => {
              if ((julyOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '08':
          ...
          items.forEach((item) => {
            augOrderItems.forEach((augOrderItem) => {
              if ((augOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '09':
          ...
          items.forEach((item) => {
            sepOrderItems.forEach((sepOrderItem) => {
              if ((sepOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '10':
          ...
          items.forEach((item) => {
            octOrderItems.forEach((octOrderItem) => {
              if ((octOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '11':
          ...
          items.forEach((item) => {
            novOrderItems.forEach((novOrderItem) => {
              if ((novOrderItem.itemID === item.itemID) && (item.rental === true)) {
        ...
        case order.date.split('-')[1] === '12':
          ...
          items.forEach((item) => {
            decOrderItems.forEach((decOrderItem) => {
              if ((decOrderItem.itemID === item.itemID) && (item.rental === true)) {
