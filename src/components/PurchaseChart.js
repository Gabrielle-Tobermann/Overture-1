...
function PurchaseChart({ orders, orderItems, items }) {
  const [chartData, setChartData] = useState({
    labels: ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
    datasets: [
      {
        label: 'Sales REvenue for 2021',
        data: [200, 320, 450, 130, 500, 600, 300, 350, 240, 450, 450, 200],
        backgroundColor: ['rgba(56, 199, 94, 0.6)'],
        borderWidth: 4
      }
    ]
  });
        ...
        case order.date.split('-')[1] === '02':
          ...
          items.forEach((item) => {
            febOrderItems.forEach((febOrderItem) => {
              if ((febOrderItem.itemID === item.itemID) && (item.rental === false) && (febItems.indexOf(item) === -1)) {
                febItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '03':
          ...
          items.forEach((item) => {
            marchOrderItems.forEach((marchOrderItem) => {
              if ((marchOrderItem.itemID === item.itemID) && (item.rental === false) && (marchItems.indexOf(item) === -1)) {
        ...
        case order.date.split('-')[1] === '04':
          ...
          items.forEach((item) => {
            apOrderItems.forEach((apOrderItem) => {
              if ((apOrderItem.itemID === item.itemID) && (item.rental === false) && (apItems.indexOf(item) === -1)) {
                apItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '05':
          ...
          items.forEach((item) => {
            mayOrderItems.forEach((mayOrderItem) => {
              if ((mayOrderItem.itemID === item.itemID) && (item.rental === false) && (mayItems.indexOf(item) === -1)) {
                mayItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '06':
          ...
          items.forEach((item) => {
            juneOrderItems.forEach((juneOrderItem) => {
              if ((juneOrderItem.itemID === item.itemID) && (item.rental === false) && (juneItems.indexOf(item) === -1)) {
                juneItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '07':
          ...
          items.forEach((item) => {
            julyOrderItems.forEach((julyOrderItem) => {
              if ((julyOrderItem.itemID === item.itemID) && (item.rental === false) && (julyItems.indexOf(item) === -1)) {
                julyItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '08':
          ...
          items.forEach((item) => {
            augOrderItems.forEach((augOrderItem) => {
              if ((augOrderItem.itemID === item.itemID) && (item.rental === false) && (augItems.indexOf(item) === -1)) {
                augItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '09':
          ...
          items.forEach((item) => {
            sepOrderItems.forEach((sepOrderItem) => {
              if ((sepOrderItem.itemID === item.itemID) && (item.rental === false) && (sepItems.indexOf(item) === -1)) {
                sepItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '10':
          ...
          items.forEach((item) => {
            octOrderItems.forEach((octOrderItem) => {
              if ((octOrderItem.itemID === item.itemID) && (item.rental === false) && (octItems.indexOf(item) === -1)) {
                octItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '11':
          ...
          items.forEach((item) => {
            novOrderItems.forEach((novOrderItem) => {
              if ((novOrderItem.itemID === item.itemID) && (item.rental === false) && (novItems.indexOf(item) === -1)) {
                novItems.push(item);
              }
            });
          });
        ...
        case order.date.split('-')[1] === '12':
          ...
          items.forEach((item) => {
            decOrderItems.forEach((decOrderItem) => {
              if ((decOrderItem.itemID === item.itemID) && (item.rental === false) && (decItems.indexOf(item) === -1)) {
                decItems.push(item);
              }
            });
          });
